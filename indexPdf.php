...
<!-- Menu Hamburguesa -->
  ...
  <div class="col-2" style="   color: white;  font-size: 25px; border-right: 1px solid #000; background-color:blue;"> 

    <form action="campus.php" method="post">
      <input type="submit" value="Enviar documento" style="margin-top: 50%;">
    </form>
...
<?php
  ...
  <!-- FORM 2 ENVIADOS -->
  <div class="col-4" style="   font-size: 20px; border-right: 1px solid #000;"> 
